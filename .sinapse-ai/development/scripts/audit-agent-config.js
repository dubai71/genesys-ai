 ...
 *
 * Analyzes all 13 SINAPSE agents to determine which core-config.yaml sections
...
async function extractAgentDependencies(agentId) {
  const agentPath = path.join('.sinapse-ai', 'agents', `${agentId}.md`);
...
*Auto-generated by SINAPSE Agent Config Audit (Story 6.1.2.6)*
`;
...
async function auditAllAgents() {
  console.log('🔍 Auditing all 13 SINAPSE agents...\n');
