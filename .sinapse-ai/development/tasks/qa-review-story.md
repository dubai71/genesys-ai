...
2. Call `getReferenceImpact(files)` from `.sinapse-ai/core/code-intel/helpers/qa-helper.js`
...
- Create directory defined in `qa.qaLocation/gates` (see `.sinapse-ai/core-config.yaml`) if missing
