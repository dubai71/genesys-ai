...
- **published_packages**: `array<object>`
  ...
  - **Example**: `[{ registry: "npm", package_name: "sinapse-ai", version: "2.1.3", url: "https://npmjs.com/package/sinapse-ai" }]`
...
sinapse release create --repo="." --type="auto"
````
