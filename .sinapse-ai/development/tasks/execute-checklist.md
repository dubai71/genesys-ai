...
If the user asks or does not specify a specific checklist, list the checklists available to the agent persona. If the task is being run not with a specific agent, tell the user to check the .sinapse-ai/checklists folder to select the appropriate one to run.
...
1. **Initial Assessment**
   ...
   - If user or the task being run provides a checklist name:
     ...
     - Load the appropriate checklist from .sinapse-ai/product/checklists/
   - If no checklist specified:
     - Ask the user which checklist they want to use
     - Present the available options from the files in the .sinapse-ai/product/checklists/ folder
