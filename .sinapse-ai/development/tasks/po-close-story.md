...
questions:
  - Story path (relative to docs/stories/):
    ...
    example: "epics/epic-pro-sinapse-pro-architecture/story-pro-5-repo-bootstrap.md"
...
*close-story epics/epic-pro-sinapse-pro-architecture/story-pro-5-repo-bootstrap.md
