...
Cria um novo squad seguindo a arquitetura task-first do SINAPSE.
...
📚 Documentation:
   ...
   - Task Format: .sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md
