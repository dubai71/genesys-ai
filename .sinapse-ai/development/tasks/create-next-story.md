...
- **Check code intelligence availability:** Call `isCodeIntelAvailable()` from `.sinapse-ai/core/code-intel`
- **If available:**
  - Call `detectDuplicateStory(storyDescription)` from `.sinapse-ai/core/code-intel/helpers/story-helper`
  ...
  - Call `suggestRelevantFiles(storyDescription)` from `.sinapse-ai/core/code-intel/helpers/story-helper`
