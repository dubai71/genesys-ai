...
```javascript
const { generateStoryIndex } = require('.sinapse-ai/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 SINAPSE Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .sinapse-ai/scripts/story-index-generator.js docs/stories"
  }
}
```
