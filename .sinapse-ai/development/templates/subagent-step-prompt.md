...
|---------|-----------|-----------|-----------|
| `core` | `.sinapse-ai/development/agents/{agent}.md` | `.sinapse-ai/development/tasks/{uses}.md` | `.sinapse-ai/data/{file}` |
...
2. If not found, check `.sinapse-ai/development/agents/{agent}.md`
