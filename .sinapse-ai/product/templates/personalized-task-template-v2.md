...
- path: .sinapse-ai/product/templates/story-tmpl.yaml
  type: input
  version: 2.1
...
- fallback: |
    ...
    2. Use generic template from .sinapse-ai/product/templates/
...
- fallback: |
    ...
    1. Check alternative data sources (.sinapse-ai/data/)
...
- **CRITICAL:** Follow SINAPSE Task Format Specification V1.0 exactly
...
- See `.sinapse-ai/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md` for complete spec
- See `.sinapse-ai/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for personality guidelines

---

**Template Version:** 2.0
**Last Updated:** 2025-01-14
**Applies to:** All tasks with SINAPSE Task Format V1.0 + Personalized Agents (Story 6.1.2+)
