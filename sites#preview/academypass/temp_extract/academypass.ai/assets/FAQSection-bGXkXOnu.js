...
var je = [{
        q: "Como faço para acessar o Academy Pass?",
        a: "Assim que você finaliza a compra, enviamos um e-mail com todas as instruções de acesso pela plataforma. É o mesmo e-mail usado na compra. Vale conferir o spam e lixo eletrônico ;)",
        visible: !0
    }, {
        ...
        a: "O Academy Pass te dá acesso aos mais de 8 cursos completos da Human Academy, com mais de 330 aulas, mais de 70h de conteúdo gravado, além das lives e workshops que ficam gravadas e disponíveis na plataforma para você assistir no seu tempo.",
        visible: !0
    }, {
        q: "Quais são os bônus do Academy Pass?",
        a: "Além de todos os cursos e aulas ao vivo semanais, você também tem acesso às lives, workshops gravados e atualizações constantes. O Academy Pass inclui ainda 1 mês de acesso ao LTX e mais de 20 ferramentas que vão te ajudar a criar com IA.",
        visible: !0
    }, {
        ...
        q: "O Academy Pass é atualizado com novas ferramentas de IA?",
        a: "Com certeza! Sempre que surge algo relevante, a gente testa no estúdio, valida o workflow e depois grava novas aulas para atualizar o Academy Pass.",
        visible: !0
    }, {
        ...
        a: "Todas as ferramentas de criação de prompts estão inclusas no Academy Pass, são elas que lhe farão economizar créditos quando for criar nas ferramentas de geração de imagem e vídeos. As assinaturas das ferramentas de geração de imagem e vídeos não estão inclusas, o que te dá liberdade de escolha.",
        visible: !0
    }, {
        ...
        q: "A Human Academy oferece desafios ou atividades práticas?",
        a: "Sim! Frequentemente promovemos desafios criativos para incentivar a prática e o desenvolvimento dos alunos.",
        visible: !1
    }, {
        ...
        a: "Para aplicar os nossos workflows você só precisa de uma boa conexão à internet, não necessita de um computador potente.",
        visible: !1
    }, {
        ...
        q: "Os cursos estão à venda separadamente?",
        a: "Os nossos cursos fazem parte de uma trilha integrada. Por isso, a gente oferece o Academy Pass como uma experiência completa.",
        visible: !1
    }],
    ye = () => {
        const {
