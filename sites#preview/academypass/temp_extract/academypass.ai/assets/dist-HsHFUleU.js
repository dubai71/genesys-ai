    ...
    const n = r.createContext(t),
        u = e => {
            const {
                children: t,
                ...u
            } = e, s = r.useMemo(() => u, Object.values(u));
    ...
    return u.scopeName = e, [function(t, u) {
        ...
        const i = t => {
            const {
                ...
                children: u,
                ...i
            } = t, a = n ? .[e] ? .[c] || s, f = r.useMemo(() => i, Object.values(i));
...
var i = globalThis ? .document ? r.useLayoutEffect : () => {},
    a = r[" useInsertionEffect ".trim().toString()] || i;
...
function f({
    ...
    const [u, s, c] = function({
        defaultProp: e,
        onChange: t
    }) {
        const [n, o] = r.useState(e), u = r.useRef(n), s = r.useRef(t);
        return a(() => {
            s.current = t
        }, [t]), r.useEffect(() => {
            u.current !== n && (s.current ? .(n), u.current = n)
        }, [n, u]), [n, o, s]
    }({
        defaultProp: t,
        onChange: n
...
var p = r[" useId ".trim().toString()] || (() => {}),
    l = 0;

function m(e) {
    const [t, n] = r.useState(p());
    return i(() => {
        e || n(e => e ? ? String(l++))
    }, [e]), e || (t ? `radix-${t}` : "")
}
export {
    s as a, u as i, f as n, i as r, m as t
};