...
export default function Select({ label, options, className='', ...props }: Props) {
  return (
    <div className="flex flex-col gap-1">
      ...
      <select className={`bg-[#111] border border-white/[0.08] rounded-[5px] px-2.5 py-[7px] text-[11px] text-[#EDDABA] outline-none focus:border-[#FF5404] transition-colors ${className}`} {...props}>
